...
class AWSTools(InstanceManager):
    ...
    def __init__(self, context, config, internal_conf) -> None:
        self.region = config.get('cloud.aws.region', internal_conf['cloud.aws.region'])
        ...
        # used as a type hint as it is generated by the factory at runtime, I assume.
        ...
        self.worker_ami = config.get(
            queue_ami_key, internal_conf[worker_ami_key])
